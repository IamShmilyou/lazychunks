...
public class LazyChunksMod implements ModInitializer {
	...
	public void onInitialize() {
		...
		LOGGER.info("Adaptive Budget Boost: {} (lowFpsThreshold={}, duration={}s, vanillaFpsThreshold={}, maxBoostCores={}, weightPerCore={})",
				config.adaptiveBudgetBoostEnabled ? "enabled" : "disabled",
