...
public final class LazyChunksLegacySodiumPage {
    ...
    public static OptionPage create() {
        ...
        groups.add(group(
                ...
                decimalOption("\u6838\u5fc3\u53d8\u5316\u95f4\u9694", "\u81ea\u9002\u5e94\u6838\u5fc3\u6570\u6bcf\u6b21\u589e\u51cf\u4e4b\u95f4\u7684\u6700\u5c0f\u95f4\u9694\u3002", 5, 50, 5,
                        (config, value) -> config.adaptiveCoreChangeIntervalSeconds = value / 10.0,
                        config -> toTenths(config.adaptiveCoreChangeIntervalSeconds)),
