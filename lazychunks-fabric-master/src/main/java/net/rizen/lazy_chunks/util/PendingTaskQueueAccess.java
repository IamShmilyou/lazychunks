...
public final class PendingTaskQueueAccess {
    private static final String OWNER_NAMED = "net.minecraft.util.thread.BlockableEventLoop";
    private static final String FIELD_NAMED = "pendingRunnables";
    ...
    private static Set<String> getCandidateFieldNames() {
        ...
        try {
            ...
            // Some development environments already expose named fields directly.
        }
